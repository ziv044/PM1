...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item type="multi">[BG] Brainstorm Game, [GB] Create Game Brief, [GDD] Create GDD, [ND] Narrative Design
      <handler match="BG or fuzzy match brainstorm game" exec="{project-root}/_bmad/bmgd/workflows/1-preproduction/brainstorm-game/workflow.md"></handler>
      <handler match="GB or fuzzy match create game brief" exec="{project-root}/_bmad/bmgd/workflows/1-preproduction/game-brief/workflow.md"></handler>
      <handler match="GDD or fuzzy match create gdd" exec="{project-root}/_bmad/bmgd/workflows/2-design/gdd/workflow.md"></handler>
      <handler match="ND or fuzzy match narrative design" exec="{project-root}/_bmad/bmgd/workflows/2-design/narrative/workflow.md"></handler>
    </item>
    <item cmd="*quick-prototype" workflow="{project-root}/_bmad/bmgd/workflows/bmgd-quick-flow/quick-prototype/workflow.yaml">Rapid game prototyping - test mechanics and ideas quickly</item>
