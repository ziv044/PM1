...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*workflow-status" workflow="{project-root}/_bmad/bmgd/workflows/workflow-status/workflow.yaml">Get workflow status or initialize a workflow if not already done</item>
    <item cmd="*sprint-planning" workflow="{project-root}/_bmad/bmgd/workflows/4-production/sprint-planning/workflow.yaml">Generate or update sprint-status.yaml from epic files (Required after GDD+Epics are created)</item>
    <item cmd="*sprint-status" workflow="{project-root}/_bmad/bmgd/workflows/4-production/sprint-status/workflow.yaml">View sprint progress, surface risks, and get next action recommendation</item>
    <item cmd="*create-story" workflow="{project-root}/_bmad/bmgd/workflows/4-production/create-story/workflow.yaml">Create Story with direct ready-for-dev marking (Required to prepare stories for development)</item>
    <item cmd="*validate-create-story">Validate Story Draft with Independent Review (Highly Recommended)</item>
    <item cmd="*epic-retrospective" workflow="{project-root}/_bmad/bmgd/workflows/4-production/retrospective/workflow.yaml" data="{project-root}/_bmad/_config/agent-manifest.csv">Facilitate team retrospective after a game development epic is completed</item>
    <item cmd="*correct-course" workflow="{project-root}/_bmad/bmgd/workflows/4-production/correct-course/workflow.yaml">Navigate significant changes during game dev sprint (When implementation is off-track)</item>
