...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*create-architecture" exec="{project-root}/_bmad/bmgd/workflows/3-technical/game-architecture/workflow.md">Produce a Scale Adaptive Game Architecture</item>
    <item cmd="*correct-course" workflow="{project-root}/_bmad/bmgd/workflows/4-production/correct-course/workflow.yaml">Course Correction Analysis (when implementation is off-track)</item>
