...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*innovate" workflow="{project-root}/_bmad/cis/workflows/innovation-strategy/workflow.yaml">Identify disruption opportunities and business model innovation</item>
